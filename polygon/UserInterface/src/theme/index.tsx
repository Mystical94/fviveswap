...
export function colors(darkMode: boolean): Colors {
  return {
    ...
    // text
    text1: darkMode ? '#fafafa' : '#ea00a6',  //Swap, token display color
    text2: darkMode ? '#4287f5' : '#4287f5',  //Slippage tolerance and balance color
    text3: darkMode ? '#fafafa' : '#4287f5',  //Enter an amount
    text4: darkMode ? '#565A69' : '#C3C5CB',
    text5: darkMode ? '#fc05b6' : '#EDEEF2',  

    // backgrounds / greys
    bg1: darkMode ? '#1d1f24' : '#fafafa', //SWAP CARD BACKGROUND
    bg2: darkMode ? '#27292e' : '#f1e9fc', //WHOLE BACKGROUND
    bg3: darkMode ? '#ea00a6' : '#e6e6e8', //BUTTONS AND BORDER COLOR
    bg4: darkMode ? '#fc0591' : '#CED0D9', //POPUP BORDER
